...
const FEEDS: FeedSource[] = [
  ...
  { name: 'Cult of Mac',         url: 'https://www.cultofmac.com/feed/',                                 siteUrl: 'https://www.cultofmac.com',              language: 'en', category: 'tech' },
  { name: 'Computerworld',       url: 'https://www.computerworld.com/index.rss',                         siteUrl: 'https://www.computerworld.com',          language: 'en', category: 'tech' },
  { name: 'Phone Arena',         url: 'https://www.phonearena.com/phones/rss',                           siteUrl: 'https://www.phonearena.com',             language: 'en', category: 'tech' },
  { name: 'NotebookCheck',       url: 'https://www.notebookcheck.net/feeds/news.xml',                    siteUrl: 'https://www.notebookcheck.net',          language: 'en', category: 'tech' },
  { name: 'GSM Arena',           url: 'https://www.gsmarena.com/rss-news-reviews.php3',                  siteUrl: 'https://www.gsmarena.com',               language: 'en', category: 'tech' },
  { name: 'Lifehacker Tech',     url: 'https://lifehacker.com/tech/rss',                                 siteUrl: 'https://lifehacker.com',                 language: 'en', category: 'tech' },
  // ── TECH ── ES ─────────────────────────────────────────────────────────────
  ...
  { name: 'Computerhoy',         url: 'https://computerhoy.20minutos.es/noticias/feeds/?rss=portada',    siteUrl: 'https://computerhoy.20minutos.es',       language: 'es', category: 'tech' },
  { name: 'TuExperto',           url: 'https://www.tuexperto.com/feed/',                                 siteUrl: 'https://www.tuexperto.com',              language: 'es', category: 'tech' },
  ...
  { name: 'New Scientist',       url: 'https://www.newscientist.com/feed/home/',                         siteUrl: 'https://www.newscientist.com',           language: 'en', category: 'innovation' },
  { name: 'Space.com',           url: 'https://www.space.com/feeds/all',                                 siteUrl: 'https://www.space.com',                  language: 'en', category: 'innovation' },
  { name: 'Live Science',        url: 'https://www.livescience.com/feeds/all',                           siteUrl: 'https://www.livescience.com',            language: 'en', category: 'innovation' },
  { name: 'Wired Science',       url: 'https://www.wired.com/feed/category/science/latest/rss',          siteUrl: 'https://www.wired.com/category/science', language: 'en', category: 'innovation' },
  { name: 'TechRepublic',        url: 'https://www.techrepublic.com/rssfeeds/articles/index.xml',        siteUrl: 'https://www.techrepublic.com',           language: 'en', category: 'innovation' },
  // ── INNOVATION ── ES ───────────────────────────────────────────────────────
  ...
  { name: 'Tendencias 21',       url: 'https://www.tendencias21.net/feeds/articles.rss',                 siteUrl: 'https://www.tendencias21.net',           language: 'es', category: 'innovation' },
  { name: 'El Confidencial Tech', url: 'https://www.elconfidencial.com/rss/tecnologia/',                 siteUrl: 'https://www.elconfidencial.com/tecnologia', language: 'es', category: 'innovation' },
  { name: 'Nobbot',              url: 'https://www.nobbot.com/feed/',                                    siteUrl: 'https://www.nobbot.com',                 language: 'es', category: 'innovation' },
  ...
  { name: 'Entrepreneur',        url: 'https://www.entrepreneur.com/latest.rss',                         siteUrl: 'https://www.entrepreneur.com',           language: 'en', category: 'business' },
  { name: 'Harvard Biz Review',  url: 'https://hbr.org/stories.rss',                                    siteUrl: 'https://hbr.org',                        language: 'en', category: 'business' },
  { name: 'Wired Business',      url: 'https://www.wired.com/feed/category/business/latest/rss',         siteUrl: 'https://www.wired.com/category/business', language: 'en', category: 'business' },
  { name: 'Protocol',            url: 'https://protocol.com/feed',                                       siteUrl: 'https://protocol.com',                   language: 'en', category: 'business' },
  // ── BUSINESS ── ES ─────────────────────────────────────────────────────────
  ...
  { name: 'América Economía',    url: 'https://www.americaeconomia.com/rss.xml',                         siteUrl: 'https://www.americaeconomia.com',        language: 'es', category: 'business' },
  { name: 'El País Economía',    url: 'https://feeds.elpais.com/mrss-s/pages/ep/site/elpais.com/section/economia/portada', siteUrl: 'https://elpais.com/economia', language: 'es', category: 'business' },
  { name: 'Expansión Empresas',  url: 'https://e00-expansion.uecdn.es/rss/empresas.xml',                 siteUrl: 'https://www.expansion.com/empresas',     language: 'es', category: 'business' },
  ...
  { name: 'Investopedia',        url: 'https://www.investopedia.com/feedbuilder/feed/getfeed/?feedName=rss_headline', siteUrl: 'https://www.investopedia.com', language: 'en', category: 'economy' },
  { name: 'Seeking Alpha',       url: 'https://seekingalpha.com/feed.xml',                               siteUrl: 'https://seekingalpha.com',               language: 'en', category: 'economy' },
  ...
  { name: 'Ámbito Finanzas',     url: 'https://www.ambito.com/rss/finanzas.xml',                         siteUrl: 'https://www.ambito.com/finanzas',        language: 'es', category: 'economy' },
  { name: 'Dinero en Imagen',    url: 'https://www.dineroenimagen.com/feed',                             siteUrl: 'https://www.dineroenimagen.com',         language: 'es', category: 'economy' },
  { name: 'El País Economía',    url: 'https://feeds.elpais.com/mrss-s/pages/ep/site/elpais.com/section/economia/portada', siteUrl: 'https://elpais.com/economia', language: 'es', category: 'economy' },
]
